...
<title>Smart Parking - Members Login</title>
...
<div class="heade" id="heade">
  ...
  <div  id="Title" class="layer2">Smart Parking - Members Login </div>
  ...
  <div class="inset">
  <p>
    <label for="vname">Vehicle Number</label>
    <input type="text" name="vname" id="vname" style="text-transform:uppercase">
  </p>
  <p>
  ...
  <p class="p-container">
    ...
    <input type="submit" name="mlogin" id="mlogin" value="Log in">
  </p>
